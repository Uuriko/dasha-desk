...
export function buildStudioEmbed(studio) {
  ...
  const embed = `<!-- Dasha Meme Studio — GENERATED by embed-build.mjs from index.html.
...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  ...
  if (process.argv.includes('--check')) {
    ...
    console.log('paste embed.html; embed.js is optional after its exact uploaded URL is recorded');
  }
}
