(() => {
  ...
  *{box-sizing:border-box}:host{margin:0;background:var(--ink);color:var(--paper);font-family:Arial,Helvetica,sans-serif;
  ...
  .topbar .brand{margin-right:auto;min-height:44px;display:inline-flex;align-items:center;color:var(--paper);font-size:17px;font-weight:900;letter-spacing:-.05em;text-decoration:none;text-transform:uppercase;font-family:"Arial Black",Arial,Helvetica,sans-serif}.topbar .brand span{color:var(--acid)}
  ...
  h1{margin:0;font-size:clamp(28px,6vw,56px);line-height:.88;letter-spacing:-.05em;text-transform:uppercase;font-weight:900;font-family:"Arial Black",Arial,Helvetica,sans-serif}
      ...
      <details>
        ...
        <div class="advanced">
          ...
          <div class="go">
            ...
            <button class="btn" id="surprise-go" type="button">Surprise me</button>
          </div>
          <div class="go">
...
if ($('surprise-go')) $('surprise-go').addEventListener('click', surpriseMe);
