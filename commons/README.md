...
Consume from another project (no getdasha import): [`docs/commons/CONSUME.md`](../docs/commons/CONSUME.md). Architecture: [`docs/commons/ARCHITECTURE.md`](../docs/commons/ARCHITECTURE.md).
