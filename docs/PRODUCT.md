...
- **dasha bounties / the board** (`/bounties`) — anybody with GitHub can list a repo or issue for USDC on Solana. X is optional and reuses the lobby Simp Board session. Static JSON feed on GitHub Pages at [uuriko.github.io/dasha-desk/bounties/feed.json](https://uuriko.github.io/dasha-desk/bounties/feed.json). The board does not hold funds.
...
- Demigod / other products (this repo does not ship Demigod; the bounties board may merge Demigod’s public listings JSON)
