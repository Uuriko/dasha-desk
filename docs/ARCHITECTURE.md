...
Commons map (Worker vs this repo, trust model, Pocket, faucet seam): [commons/ARCHITECTURE.md](commons/ARCHITECTURE.md). Other projects: [commons/CONSUME.md](commons/CONSUME.md). External community (not getdasha): [commons/EXTERNAL.md](commons/EXTERNAL.md). Pocket: [commons/POCKET.md](commons/POCKET.md) → [Uuriko/dasha-pocket](https://github.com/Uuriko/dasha-pocket).
