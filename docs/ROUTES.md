...
| `/bag` | On-chain facts. |
| `/simp` | Quiz / board. |
| `/lobby` | The one community room. Official TG `https://t.me/+ck9pUjL2ncNiZjRh` may live in the footer. Quiet pin: no mint/Buy/Chess/TG dump. `id=forum-play` stays gone. |
