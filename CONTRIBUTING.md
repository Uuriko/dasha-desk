...
**Live path (no clone):** open [Start.](https://www.getdasha.com/compute) → Ask · Provide · Pay · Credits. Gate is **Log in** / **You**. After Ask, Hosted. Provide is the Mac kit. Marketplace / Host stay quieter. Studio is local / Pages only; www `/studio` 308s home.
